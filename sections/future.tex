It is possible to backward extend the samples from 2015 to 2008 by including Wikipedia activity data for which bots have not been filtered out. This would about double the saple count, and might, if the un filtered away bot activity does not introduce too much noice, allow individual classifiers to cross the statistical significance threshold.
