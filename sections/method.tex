...
The experiment, being multilingual, neceitates a language agnostic representation of each article, to be able to answer the question: \emph{given no knowledge of language or location at all, what kind of culture does this daily top 1,000 article matrix come from?}
To achive this language agnostic summary representation the raw text was, after basic tokenization, converted projectd onto MUSE word embedding space.
...
As the average article are present in an average of 29 different dates, article storage utilization was cut by constructing daily sampels on the fly.
